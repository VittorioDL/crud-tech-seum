        ...
        <div class="row">
            <div class="col-lg-4 bg-success p-2 text-black bg-opacity-75">
                <ul>
		            ...
		            <li>
		    	        <input name="anno_inizio_uso" type="number" class="col-auto my-2" min="1800" step="1" placeholder="Anno inizio uso"><br><br>
		            </li>
	                <li>
			            <input name="anno_fine_uso" type="number" class="col-auto my-2" min="1800" step="1" placeholder="Anno fine uso"><br><br> 
	                </li>
                    <li>
                        <!-- Selezione stato -->
