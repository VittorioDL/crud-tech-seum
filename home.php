...
<body>
    ...
    <div class="container">
        <button class="btn btn-success my-5"> <a href="#" class="text-light text-decoration-none">Aggiungi reperto</a></button>
    </div>
    ...
    <form action='ricerca-reperti.php' method='post'>
        <div class="container">
            <div class="input-group mb-3">
                ...
                <button class="btn btn-info" type="button" id="button-addon1">Cerca</button>
                </div>
